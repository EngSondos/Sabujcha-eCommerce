...
$brandobj = new Brand;
$brands=$brandobj->all()->fetch_all(MYSQLI_ASSOC);
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-banner img-zoom mb-30">
                                ...
                                <a href="shop.php?brand=<?=$brand['id']?>">
                                    <img src="assets/img/brand-logo/<?=$brand['image']?>" alt="">
                                </a>
                ...
                <div class="product-top-bar section-border mb-55">
                    <div class="section-title-wrap text-center">
                        ...
                        <div class="row">
							...
							$result =$productObj->getMostREcentProduct();
							if($result){
            ...
            <div class="container">
                <div class="product-top-bar section-border mb-55">
                    <div class="section-title-wrap text-center">
                        ...
                        <div class="row">
							<?php 
							$result =$productObj->getMostProductOrderd();
							if($result){
								$productso =$result->fetch_all(MYSQLI_ASSOC);
								// print_r($productso);
								foreach($productso as $index => $product){ ?>
                            <div class="col-3">
								<div class="product-wrapper mb-30">
									<div class="product-img">
										<a href="">
